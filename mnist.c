...
int main(int argc, char ** argv) {
  ...
  for (size_t i = 0; i < NUM_PICTURES*PICTURE_SIZE; i++) {
    ...
    input_data[i] = ((double) buff/255.0f)*1000.0f;
  }
  ...
  for (size_t i = 0; i < NUM_PICTURES; i++) {
    ...
    expected_data[(i*OUTPUT_LAYER_SIZE) + (size_t) buff] = 1000.0f;
  }
...
char numToText(double num) {
  char letter = 0;
  if (num > (229.5/255.0f)/1000.0f)
    letter = '@';
  else if (num > (204/255.0f)/1000.0f)
    letter = '#';
  else if (num > (178.5/255.0f)/1000.0f)
    letter = '8';
  else if (num > (153/255.0f)/1000.0f)
    letter = '&';
  else if (num > (127.5/255.0f)/1000.0f)
    letter = 'o';
  else if (num > (102/255.0f)/1000.0f)
    letter = ';';
  else if (num > (76.5/255.0f)/1000.0f)
    letter = '*';
  else if (num > (51/255.0f)/1000.0f)
    letter = '.';
  else
    letter = ' ';
